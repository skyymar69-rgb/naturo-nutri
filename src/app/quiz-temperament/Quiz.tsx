    ...
    <Container size="prose" className="py-12 sm:py-16">
      ...
      <Card accent="cream" className="animate-fade-in">
        <CardContent className="p-6 sm:p-10">
          <Badge variant="sage" className="mb-4 capitalize">
                  ...
                  <span
                    className={cn(
                      ...
                      isSelected
                        ...
                        : 'border-forest-300 bg-transparent',
                    )}
                  >
                    {isSelected && <CheckCircle2 className="h-4 w-4" />}
                  </span>
                  <span className="text-sm sm:text-base text-forest-800 leading-relaxed">
                    {option.label}
                  </span>
                </button>
              );
...
function Result({ result, onRestart }: { result: QuizResult; onRestart: () => void }) {
  ...
  const sortedTemperaments = [...TEMPERAMENT_SLUGS].sort(
  ...
  return (
    <Container size="prose" className="py-12 sm:py-16">
      <div className="text-center mb-12 animate-fade-in">
        ...
        <p className="text-xs uppercase tracking-[0.18em] text-earth-600 mb-3 font-medium">
          Votre résultat
        </p>
      ...
      <Card accent="forest" className="overflow-hidden mb-8 animate-slide-up">
        <div
          className="p-8 text-cream-50"
          style={{
            background: `linear-gradient(135deg, ${dominant.couleurHex}cc, ${dominant.couleurHex}99)`,
          }}
        >
        ...
        <CardContent>
          <div className="grid sm:grid-cols-2 gap-6">
            <div>
              <h3 className="font-display text-base font-semibold text-forest-900 mb-2">
                Vos forces
              </h3>
                ...
                <div key={slug}>
                  <div className="flex items-center justify-between mb-1.5 text-sm">
                    <span className="flex items-center gap-2">
                      <span>{t.emoji}</span>
                      <span className="font-medium text-forest-800">{t.nom}</span>
                    </span>
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        <ButtonLink href={`/temperaments/${dominant.slug}`} variant="primary" size="lg">
      ...
      <div className="mt-12 text-center">
        ...
        <Link
          href={`/temperaments/${secondary.slug}`}
